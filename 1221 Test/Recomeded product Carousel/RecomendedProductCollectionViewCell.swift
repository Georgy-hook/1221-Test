//
//  RecomendedProductCollectionViewCell.swift
//  1221 Test
//
...
class RecomendedProductCollectionViewCell: UICollectionViewCell {
    
    static let reuseId = "RecomendedProductCollectionViewCell"
    ...
    private func setupUI() {
        ...
        NSLayoutConstraint.activate([
            ...
            productImageView.widthAnchor.constraint(equalTo: widthAnchor , multiplier: 0.7),
            ...
            discountedPriceLabel.leadingAnchor.constraint(equalTo: leadingAnchor, constant: 5),
            discountedPriceLabel.bottomAnchor.constraint(equalTo: cartButton.bottomAnchor),
            
            // Cart button constraints
            cartButton.trailingAnchor.constraint(equalTo: trailingAnchor, constant: -5),
            cartButton.bottomAnchor.constraint(equalTo: bottomAnchor, constant: -5),
    ...
    func configure(with product: RecomededProductItem) {
    ...
    private func updateContraintsForPriceLabel(){
